 ...
 * /app/src/main/java/com/example/android/navigationadvancedsample/NavigationExt.kt
 */
...
fun NavController.navigateSafe(@IdRes resId: Int, args: Bundle? = null,navOptions: NavOptions? = getNavOptions()) {
...
fun resetNavHostDestinationToStart(
    fragmentTag: String,
    fragmentManager: FragmentManager,
