...
public class PermissionUtil {
    ...
    public interface PermissionMessage {
        String READ_PHONE_STATE = BaseApp.INSTANCE.getString(R.string.permission);
        String WRITE_EXTERNAL_STORAGE = BaseApp.INSTANCE.getString(R.string.write_external_storage_title);
        String CAMERA = BaseApp.INSTANCE.getString(R.string.camera_title);
    }
