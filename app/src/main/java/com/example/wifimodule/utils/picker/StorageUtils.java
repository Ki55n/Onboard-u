...
public class StorageUtils {
    ...
    public static String createExternalDirectory() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            File baseDirFile = BaseApp.Companion.getINSTANCE().getExternalFilesDir(Environment.DIRECTORY_PICTURES);
            if (baseDirFile != null) {
                baseDir = baseDirFile.getAbsolutePath();
            }
        }
        if (baseDir == null) {
            baseDir = BaseApp.Companion.getINSTANCE().getFilesDir().getAbsolutePath();
        }
        return baseDir;
    }

    public static String createInternalDirectory() {
        return BaseApp.Companion.getINSTANCE().getFilesDir().getAbsolutePath();
    }
