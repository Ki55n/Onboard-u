package com.osquare.prettyDialog
...
class PrettyDialogButton : LinearLayout {
    ...
    private fun makeSelector(color: Int): StateListDrawable {
        ...
        pressed_drawable.cornerRadius = resources.getDimensionPixelSize(R.dimen._8sdp).toFloat()
        val default_drawable = GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, intArrayOf(color, color))
        default_drawable.cornerRadius = resources.getDimensionPixelSize(R.dimen._8sdp).toFloat()
